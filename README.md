<div align="center">
  <img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=180&section=header&text=EDA%20Projects&fontSize=32&fontColor=ffffff&animation=twinkling&fontAlignY=35"/>
</div>

# EDA-Projects

Collection of exploratory data analysis projects covering various datasets with comprehensive statistical analysis and visualizations.
...
```bash
git clone https://github.com/Abdul-Insighht/EDA-Projects.git
cd EDA-Projects
```
...
â­ [Star this repo](https://github.com/Abdul-Insighht/EDA-Projects) â€¢ ðŸ› [Report Bug](https://github.com/Abdul-Insighht/EDA-Projects/issues) â€¢ ðŸ’¡ [Request Feature](https://github.com/Abdul-Insighht/EDA-Projects/issues)
